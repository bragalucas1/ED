...
template<class T>
void MyList<T>::destroy(MyList<T>::iterator first) {
...
template<class T>
void MyList<T>::destroy() { // Lab...
	dataSize = 0;
	destroy(dataFirst);
}


//Aula: comecar por erase, construtor, operator =,...





//Exercicio: somar elementos da lista recursivamente..
